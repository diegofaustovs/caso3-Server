...
public class ThreadServidor extends Thread{
	...
	/**
	 * 
	 * Atributos de control de tiempo para autenticaci髇
	 * 
	 */
	...
	private long clientRespStartTime;
	private long clientRespEndTime;
	...
	public void run() {
		...
		while (true) {
			...
			try {
				...
				System.out.println("Tiempo de autenticaci髇: " + (authEndTime - authStartTime));
				//////////////////////////////////////////////////////////////////////////
				...
				clientRespStartTime = System.nanoTime();
				...
				// No deberia alcanzarce en condiciones normales de ejecuci贸n.
				e.printStackTrace();
